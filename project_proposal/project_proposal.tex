...
common objectives.\\
\\
Detailed step-by-step instructions (\href{https://docs.google.com/document/d/1Efj_dul7iRcpWMyoVltM_xot4q2QfqkbW58DAR2TuFo/edit}{taken from course project description}):
\begin{enumerate}
  \setcounter{enumi}{-1}
